...
// ############################## CHANGE THIS ###############################################################
var page="&page=Timeline_of_Polish_history";     
...
// ############################## CHANGE THIS ###########################
var DESTINATION_FOLDER = "Poland";  //CHANGE THIS FOR OTHER COUNTRY
// ######################################################################
...
// ############################## CHANGE THIS ###########################
    country = "Poland"; //CHANGE HERE FOR OTHER COUNTRY
// ######################################################################
...
// ############################## CHANGE THIS ###########################
    Poland: [] //CHANGE HERE FOR OTHER COUNTRIES
// ######################################################################
...
//    1st value was "year","date" & "event"..2nd object has already been used
    for (var i = 1; i < last_year; i++) {
        ...
        if(isNaN(parseInt(year[i]))){ // if the year column is null, that means there are more events in that year
            ...
            // ############################## CHANGE THIS ###########################
                obj.Poland.push(event_details); //CHANGE HERE FOR DIFFERNET COUNTRIES
            // #######################################################################
                i++;
...
//            https://stackoverflow.com/questions/21976567/write-objects-into-file-with-node-js?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
        ...
        // ############################## CHANGE THIS ###########################
            obj.Poland = [];     //CHANGE HERE FOR DIFFERNET COUNTRIES
        // ############################## CHANGE THIS ###########################
